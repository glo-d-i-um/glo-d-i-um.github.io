...
\<[<http://www.archivi.beniculturali.it/index.php/abc-degli-archivi/glossario>\>]{.underline}

*\*Archivio* (*s*.*v*.), in *Lombardia Beni Culturali. Glossario*,
\<[<http://www.lombardiabeniculturali.it/archivi/glossario/>\>]{.underline}

*ICA. International Council on Archives*,
\<[<https://www.ica.org/en>\>]{.underline}
...
\<[[http://edizionicafoscari.unive.it/media/pdf/books/978-88-6969-183-6/978-88-6969-183-6\_IhKmUbC.pdf]{.underline}](http://edizionicafoscari.unive.it/media/pdf/books/978-88-6969-183-6/978-88-6969-183-6_IhKmUbC.pdf)\>
...
\<[[https://fri.hypotheses.org/glossario-di-informatica-umanistica]{.underline}](https://fri.hypotheses.org/glossario-di-informatica-umanistica)\>
...
Humanities* ,
\<[[https://fri.hypotheses.org/1391]{.underline}](https://fri.hypotheses.org/1391)\>

\**Beta code* (*s.v*.), in *Wikipedia*,
\<[[https://en.wikipedia.org/wiki/Beta\_Code]{.underline}](https://en.wikipedia.org/wiki/Beta_Code)\>

*Duke Databank of Documentary Papyri*,
\<[[https://papyri.info/docs/ddbdp]{.underline}](https://papyri.info/docs/ddbdp)\>

*Greek Beta code converter*,
\<[[https://chrome.google.com/webstore/detail/greek-beta-code-converter/abelaepcjjpjpkhpbbeggnijcccphpnp]{.underline}](https://chrome.google.com/webstore/detail/greek-beta-code-converter/abelaepcjjpjpkhpbbeggnijcccphpnp)\>

*Packard Humanities Institute* (official website), \<
[[https://packhum.org/]{.underline}](https://packhum.org/)\>

\**Packard Humanities Institute* (*s.v.*), in *Wikipedia*,
\<[[https://en.wikipedia.org/wiki/Packard\_Humanities\_Institute]{.underline}](https://en.wikipedia.org/wiki/Packard_Humanities_Institute)\>
...
[[https://en.wikipedia.org/wiki/Perseus\_Project]{.underline}](https://en.wikipedia.org/wiki/Perseus_Project)\>

*The Beta code manual*, in *TLG*,
\<[[http://www.tlg.uci.edu/encoding/]{.underline}](http://www.tlg.uci.edu/encoding/)\>

\**Thesaurus Linguae Graeciae* (*s.v.*), in *Wikipedia*,
\<[[https://en.wikipedia.org/wiki/Thesaurus\_Linguae\_Graecae]{.underline}](https://en.wikipedia.org/wiki/Thesaurus_Linguae_Graecae)\>

*TLG Beta code quick Reference Guide*,
\<[[https://www.tlg.uci.edu/encoding/quickbeta.pdf]{.underline}](https://www.tlg.uci.edu/encoding/quickbeta.pdf)\>

*TLG* (*sub-corpus* del) in *open access*: *Canon of Greek Authors and
Works (Abridged TLG*),
\<[[http://stephanus.tlg.uci.edu/Iris/canon/csearch.jsp]{.underline}](http://stephanus.tlg.uci.edu/Iris/canon/csearch.jsp)\>
...
Irvine), \<
[[http://stephanus.tlg.uci.edu/]{.underline}](http://stephanus.tlg.uci.edu/)\>

\**Unicode* (*s.v.*), in *Wikipedia*,
\<[[https://it.wikipedia.org/wiki/Unicode]{.underline}](https://it.wikipedia.org/wiki/Unicode)\>
...
\<[<https://pdfs.semanticscholar.org/d0e6/90b74b3b9513d9d1f97cf366e31a3920a4bf.pdf>\>]{.underline}
...
\<[<https://ac.els-cdn.com/S0306457398000582/1-s2.0-S0306457398000582-main.pdf?_tid=25a411f0-fe0b-11e7-9e69-00000aacb35d&acdnat=1516471137_5866310621e56d197c1a9a06dce0917d>\>]{.underline}
...
\<[<http://bollettino.aib.it/article/view/8394/7498>\>]{.underline}
...
\<[<http://digitalia.sbn.it/article/view/325/215>\>]{.underline}

## Sitografia {-}

\**Biblioteca digitale* (*s.v.*), in *Treccani*,
\<[[http://www.treccani.it/enciclopedia/biblioteca-digitale\_%28Enciclopedia-Italiana%29/](http://www.treccani.it/enciclopedia/biblioteca-digitale_(Enciclopedia-Italiana)/)\>]{.underline}

\**Biblioteca virtuale* (*s.v.*), in *Treccani*,
\<[[http://www.treccani.it/enciclopedia/biblioteca-virtuale\_%28XXI-Secolo%29/](http://www.treccani.it/enciclopedia/biblioteca-virtuale_(XXI-Secolo)/)\>]{.underline}

*BNCF - Biblioteca Nazionale Centrale di Firenze*,
\<[<http://thes.bncf.firenze.sbn.it/termine.php?id=30683>\>]{.underline}

*DLF - Digital Library Federation*,
\<[<https://old.diglib.org/about/dldefinition.htm>\>]{.underline}

*DLF - Digital Library Federation*,
*\<*[<https://www.diglib.org/?s=definition+of+digital+librar>\>]{.underline}

*ICCU*, *Studio di fattibilità per la realizzazione della Biblioteca
Digitale*:
\<[[http://www.iccu.sbn.it/upload/documenti/BDI-SDF.pdf]{.underline}](http://www.iccu.sbn.it/upload/documenti/BDI-SDF.pdf)\>
(sezione prima);
\<[<http://www.iccu.sbn.it/upload/documenti/BDI-SDF-Prog.pdf>\>]{.underline}
(sezione seconda)
...
\**Browser* (*s*.*v*.), in *Tech Terms*,
\<[[https://techterms.com](https://techterms.com/)\>]{.underline}

*How Browsers Work: Behind the scenes of modern web browsers*,
\<[<https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#The_browser_main_functionality>\>]{.underline}

\**Web Browser* (*s*.*v*.), in *Intro to ITC*,
\<[h[ttp://openbookproject.net/courses/intro2ict/web/web\_browsers.html](http://openbookproject.net/courses/intro2ict/web/web_browsers.html)\>]{.underline}
...
\<[<http://dizionari.corriere.it/dizionario_italiano/C/concordanza.shtml>\>]{.underline}

\**Concordance* (*s.v*.), in *Wikipedia* (EN),
\<[<https://en.wikipedia.org/wiki/Concordance_(publishing)>\>]{.underline}

*The rise of the* *machines* in *Humanities*. *The Magazine of the
National Endowment for the humanities*,
\<[<https://www.neh.gov/humanities/2013/julyaugust/feature/the-rise-the-machines>\>]{.underline}
...
\<[[http://discovery.ucl.ac.uk/1447269/1/MTerras\_Crowdsourcing%20in%20Digital%20Humanities\_Final.pdf]{.underline}](http://discovery.ucl.ac.uk/1447269/1/MTerras_Crowdsourcing%20in%20Digital%20Humanities_Final.pdf)\>

## Sitografia {-}

\**Crowdsourcing* (*s.v*.), in *Wikipedia*,
\<[<https://it.wikipedia.org/wiki/Crowdsourcing>\>]{.underline}

Frost D. R., *Crowdsourcing, Undergraduates, and Digital Humanities
Projects*,
\<[<https://rebeccafrostdavis.wordpress.com/2012/09/03/crowdsourcing-undergraduates-and-digital-humanities-projects/>\>]{.underline}

Howe J., *The rise of crowdsourcing*,
\<[<https://www.wired.com/2006/06/crowds/>\>]{.underline}

Mazzini E.*, Il crowdsourcing tra necessità di coordinamento e perdita
di controllo*/Capitolo 1 -- *Il Crowdsourcing*,
\<[[https://it.wikisource.org/wiki/Il\_crowdsourcing\_tra\_necessit%C3%A0\_di\_coordinamento\_e\_perdita\_di\_controllo/Capitolo\_1\_%E2%80%93\_Il\_Crowdsourcing](https://it.wikisource.org/wiki/Il_crowdsourcing_tra_necessità_di_coordinamento_e_perdita_di_controllo/Capitolo_1_–_Il_Crowdsourcing)\>]{.underline}

Pezzali M., *Crowdsourcing: quando la rete... trova la soluzione*, in
*Il Sole 24 ore*,
\<[<https://www.ilsole24ore.com/art/SoleOnLine4/Economia%20e%20Lavoro/2009/02/crowdsourcing-rete-soluzione.shtml>\>]{.underline}

Van Ess H., *Harvesting Knowledge. Success criteria and strategies for
crowdsourcing*,
\<[[https://www.slideshare.net/StifoPers/presentatie-henk-van-ess]{.underline}](https://www.slideshare.net/StifoPers/presentatie-henk-van-ess)\>
...
\**W3CSS* (*s.v*.), in *w3schools.com*,
\<[<http://www.w3schools.com/>\>]{.underline}
...
*computer* *graphics* inaugura la *Data Visualization* digitale che si è
...
mole di dati disponibili all'indagine umanistica. Un progetto di *Data
Visualization* attualmente in vigore è il *Mapping the Republic of
...
([[http://republicofletters.stanford.edu/index.html]{.underline}](http://republicofletters.stanford.edu/index.html)).

Tra i principali tool delle *Data Visualization* si annoverano:

1.  Tableau: (a pagamento) in grado di produrre grafici e
    visualizzazioni interattive avanzate;

2.  Infogram: utile per la creazione di infografiche, semplice e veloce
    da utilizzare;

3.  Carto: adatto alla pubblicazione di mappe online;

4.  Google Chart Tools: che consente la creazione di un'ampia gamma di
    grafici embeddabili all'interno dei siti web.

L'efficacia delle *Data Visualization* trova conferma, oltre che in
...
all'avanguardia. Il TACC (*Texas Advanced Computing Center*), ad
...
([[https://www.tacc.utexas.edu/research-development/tacc-projects/a-thousand-words]{.underline}](https://www.tacc.utexas.edu/research-development/tacc-projects/a-thousand-words)).

## Bibliografia consigliata {-}

Fischetti T. *et al*., *Data Analysis and Visualization*, Birmingham,
Packt, 2016

Murray S., *Interactive Data Visualization for the Web*, Sebastopol
(CA), O'Reilly Media, 2013

Stephen A. T., *Data Visualization with Javascript*, USA, No Starch
Press, 2015

Telea A. C., *Data Visualization. Principles and Practice*, Boca Raton
(FL), CRC, 2015

## Sitografia {-}

\**Data Visualization* (*s.v*.), in *Wikipedia*,
\<[<https://en.wikipedia.org/wiki/Data_visualization>\>]{.underline}

*Mapping the Republic of Letters,
\<*[<http://republicofletters.stanford.edu/index.html>\>]{.underline}

Minguzzi G., *Data Visualization: quando i numeri raccontano le storie*,
\<[<https://www.merita.biz/data-visualization/>\>]{.underline}

Minto P., *Data Visualization, una storia/1*,
\<[<https://www.rivistastudio.com/data-visualization-una-storia/>\>]{.underline}

Minto P., *Data Visualization, una storia/2*,
\<[<https://www.rivistastudio.com/data-visualization-2/>\>]{.underline}

*TACC* - *Texas Advanced Computing Center*,
\<[<https://www.tacc.utexas.edu/research-development/tacc-projects/a-thousand-words>\>]{.underline}

Zambon M., *Glossario: Data Visualization*,
\<[<https://www.tagmanageritalia.it/glossario-data-visualization/#gref>\>]{.underline}

Zepel T., *Visualization as Digital Humanities?*,
\<[<https://www.hastac.org/blogs/tzepel/2013/05/02/visualization-digital-humanities>\>]{.underline}
...
Un *database* è una collezione di dati omogenei per contenuto e formato,
...
della progettazione). Un *DB* è solitamente interrogabile da
...
di interrogazione per *DB* è detto 'query language' (linguaggio di
ricerca). La classe di software per la creazione e la gestione dei *DB*
è detta DBMS (*Database Management System*); uno dei più diffusi e
maggiormente supportati è l'open-source Mysql, rilasciato dalla Oracle.

Esempio: *BEDT -- Bibliografia Elettronica dei Trovatori* (Direzione
...
L'espressione *Digital Dark Age*, di conio alquanto recente, è attestata
per la prima volta nel 1997 in una relazione presentata nella Conferenza
dell'*International Federation of Library Associations and Institutions*
(IFLA) ed è stata successivamente ripresa e 'valorizzata' nel Convegno
intitolato *Time and Bits* a cura della *Long Now Foundation* e del
*Getty Conservation Institute* nel 1998. L'espressione è parzialmente
...
La definizione di *Digital Dark Age* è legata alla dicotomia concettuale
'digital preservation' \~ 'digital obsolescence'. In particolare, il
...
il problema della 'usability': è necessario che i digital data siano
...
ad elaborare (analytic) tools -- come il *cloud-based storage* -- e
...
Howell A., *Perfect One Day -- Digital The Next: Challenges in
Preserving Digital Information*, in *Australian Academic & Research
Libraries,* 31, 4, 2013, pp. 121-141
\<[[https://www.tandfonline.com/doi/pdf/10.1080/00048623.2000.10755130]{.underline}](https://www.tandfonline.com/doi/pdf/10.1080/00048623.2000.10755130)\>

Ross H. D., *Preserving Digital Materials*, München, Rowman &
Littlfield, 2005

## Sitografia {-}

\**Digital Dark Ages* (*s.v*.), in *LisWiki* ,
\<[[https://liswiki.org/wiki/Digital\_Dark\_Ages]{.underline}](https://liswiki.org/wiki/Digital_Dark_Ages)\>

*IFLA - International Federation of Library Associations and
Institutions*,
\<[[https://www.ifla.org/]{.underline}](https://www.ifla.org/)\>

Kuny T., *A Digital Dark Ages? Challenges in the Preservation of
Electronic Information*, relazione presentata al *Workshop: Audiovisual
...
\<[[https://archive.ifla.org/IV/ifla63/63kuny1.pdf]{.underline}](https://archive.ifla.org/IV/ifla63/63kuny1.pdf)\>

\**Obsolescenza digitale* (*s.v*.), in*Treccani* ,
\<[[http://www.treccani.it/enciclopedia/obsolescenza-digitale\_%28Lessico-del-XXI-Secolo%29/]{.underline}](http://www.treccani.it/enciclopedia/obsolescenza-digitale_(Lessico-del-XXI-Secolo)/)\>

\**Obsolescenza digitale* (*s.v*.), in *Wikipedia*,
\<[[https://it.wikipedia.org/wiki/Obsolescenza\_digitale]{.underline}](https://it.wikipedia.org/wiki/Obsolescenza_digitale)\>

Rusbridge C., *Excuse me\... some Digital Preservation Fallacies?*, in
*Web Magazine for Informations Professionals*,
\<[[http://www.ariadne.ac.uk/issue46/rusbridge/]{.underline}](http://www.ariadne.ac.uk/issue46/rusbridge/)\>

Shave L., *It's a digital world. Records and information Management
Professionals. Guide to avoid Digital Dark Ages*,
\<[[http://rimpa.com.au/assets/2015/09/eBook-Avoiding-the-digital-dark-age.pdf]{.underline}](http://rimpa.com.au/assets/2015/09/eBook-Avoiding-the-digital-dark-age.pdf)\>

\[*Giovanna Battaglino*\]

# Digital Death

Con il termine *Digital Death* si intende solitamente l'insieme delle
...
*Digital Death*: 1) gli effetti che la morte di un singolo individuo
produce all'interno della realtà digitale e, quindi, nella vita 'reale'
...
Definito anche identificatore persistente, il *DOI* identifica un
...
L'associazione del *DOI* all'oggetto è totalmente univoca: attraverso il
*DOI*, infatti, si accede alla pagina Internet contenente l'oggetto e se
l'oggetto viene spostato si sposta anche il *DOI* che lo identifica.
...
Dato un *DOI* di questo tipo: 10.1491/napoli081995, il prefisso è
10.1491, di cui 10 identifica il *DOI*, mentre 1491 indica il
registrante; napoli081995 è il suffisso che coincide con l'oggetto.

A occuparsi della registrazione dei *DOI* c'è la *multilingual European
DOI Registration Agency*, meglio nota come mEDRA, l'*Agenzia Europea di
Registrazione del* *DOI*, nominata dall'IDF (*International DOI
Foundation*, [[www.doi.org]{.underline}](http://www.doi.org/)) il primo
luglio 2003.
...
*DOI*, eliminando le barriere economiche, consentendone l'utilizzo anche
ai piccoli editori e incentivandone, in questo modo, il processo di
standardizzazione.

## Bibliografia consigliata {-}

ISO 26324*,* *International Standard. Information and documentation --
Digital Object Identifier system*, Switzerland, ISO, 2012

## Sitografia {-}

\**DOI-Digital Object Identifier* (*s.v*.), in *Wikipedia*,
\<[<https://it.wikipedia.org/wiki/Digital_object_identifier>\>]{.underline}

*DOI. Un código esencial para citas bibliográficas y búsquedas
científicas,
\<*[<http://infobib.blogspot.com/2009/04/doi-un-codigo-esencial-para-citas.html>\>]{.underline}

*mEDRA*, \<[<https://www.medra.org/it/DOI.htm>\>]{.underline}

*mEDRA -- multilingual DOI Registration Agency*,
\<[<http://www.aie.it/Portals/_default/Skede/Allegati/Skeda105-1466-2007.5.2/Medra%20brochure%20applicazioni%20IT.pdf>\>]{.underline}

*Servizi SBA: Informazioni sul DOI*,
\<[<http://biblioteche.unige.it/node/255>\>]{.underline}
...
La *DTD* è un linguaggio per definire la grammatica che descrive la
...
La *DTD* è un insieme di dichiarazioni che principalmente determinano
...
separano i vari elementi. Le *DTD* risultano, quindi, molto utili per la
...
Ogni *DTD* può essere, arbitrariamente, interna o esterna (in questo
...
Ausiello G. *et al*., *Modelli e linguaggi dell\'informatica*, Milano,
McGraw-Hill, 1991

Ciotti F., *Il testo e l'automa. Saggi di teoria e critica
computazionale dei testi letterari*, Roma, ARACNE Editrice s.r.l., 2007

Møller A. - Schwartzbach M.I. - Gaburri S. (a cura di), *Introduzione a
...
(ingl. Acronimo per *Encoded Archival Description*)

L\'*Encoded Archival Description* (EAD) è uno strumento per la
...
come l'*eXtensible Markup Language* (XML), volte alla conservazione e
...
Lo standard prende forma nell\'ambito del *Berkeley Finding Aids
...
elenchi sommari, indici utilizzando lo *Standard Generalised Mark-up
Language* (SGML)**.** La versione 1.0 di *EAD* è stata rilasciata nel
1998, accompagnata dalla pubblicazione della *Tag library* e
delle *Application guidelines* sul sito ufficiale del progetto, ospitato
in quello della Library of Congress che era diventata l'agenzia
responsabile del mantenimento di *EAD*.
...
del 2000 dello standard di descrizione archivistica ISAD(G), *General
...
nuove opportunità cui sembrano aprire i *Linked Open Data* -- si è
...
*Tag Library* e al foglio di stile che dovrebbe garantire il passaggio
da *EAD* 2002 a EAD3.

Nell'estate del 2015 la versione EAD3 è stata adottata come standard
dalla *Society of American Archivists* (SAA).

## Bibliografia consigliata {-}

Carucci P. - Guercio M., *Manuale di archivistica*, Roma, Carocci, 2008

Michetti G. (a cura di), *EAD: Encoded archival description tag library
= Descrizione archivistica codificata dizionario dei marcatori*, Roma,
ICCU, 2005

Pala F., *Lo standard EAD3 per la codifica dei dati archivistici:
qualche novità e molte conferme*, in *J-LIS*, 8, 3, 2017, pp. 148-176

Pitti D., *Encoded Archival Description: The Development of an Encoding
Standard for Archival Finding Aids*, in *The American Archivist*, 60, 3,
1997, pp. 268-283

## Sitografia {-}

*EAD - Encoded Archival Description* (official site),
\<[[http://www.loc.gov/ead/index.html]{.underline}](http://www.loc.gov/ead/index.html)\>

*ICAR - Istituto Centrale per gli Archivi*,
\<[[http://www.icar.beniculturali.it/index.php?id=52]{.underline}](http://www.icar.beniculturali.it/index.php?id=52)\>

\[*Concetta Damiani*\]

# Feed RSS

(ingl. Acronimo per *Rich Site Summary/ RDF Site Summary o Really Simple
Syndication*)

Quando si parla di *Feed RSS* ci si riferisce a un flusso, di un'unità
...
esistono differenti versioni di *RSS*. Una prima versione 0.90 venne
sviluppata da Netscape nel 1999, seguita da una versione semplificata,
la 0.91. Il vero sviluppo avvenne però per mano del team di 'content
management' di Userland che, partendo dal formato RDF (*Resource
...
nome di RSS 2.0. La vasta popolarità del formato *RSS* e la sua lunga
storia hanno fatto in modo che il termine *Feed RSS* venga utilizzato
spesso come sinonimo di 'web feed'. Si tratta però di un uso incorretto
del termine in quanto non tutti i formati di *feed* sono *RSS*, ad
esempio oggi un altro formato di vasto utilizzo è Atom, un diretto
concorrente di *RSS*.

Nella sua forma più semplice un *Feed RSS* è composto da un elemento
principale \<*rss*\> seguito da un elemento \<*channel*\> e dai suoi
sotto elementi \<*item*\>. L'elemento \<*channel*\> deve contenere tre
...
ha creato il *Feed RSS*.

La funzione principale dei *Feed RSS* è garantire la semplicità di
...
lettore è necessario fare uso di *Feed Reader* o aggregatori in grado di
...
\**RSS* (*s.v*.), in *Tech Terms*,
\<[[https://techterms.com](https://techterms.com/)\>]{.underline}

*RSS Advisory Board*,
\<[<http://www.rssboard.org/rss-specification#whatIsRss>\>]{.underline}

*Rss20AndAtom10Compared*,
\<[<http://www.intertwingly.net/wiki/pie/Rss20AndAtom10Compared>\>]{.underline}
...
La *filologia* *digitale* si configura come il punto di intersezione fra
l'ecdotica e l'informatica. Pertanto, la definizione di *filologia
digitale* non può essere scissa dalla definizione di *edizione
digitale*. In prima istanza, la *filologia digitale* potrebbe essere
...
generale, la *filologia digitale* come «l'uso di strumenti e metodi
...
testi supplementari (quali commenti, edizioni critiche precedenti *et
similia*); la possibilità di consultare i vari testimoni. *Brevibus
...
che, naturalmente, non si esauriscono nella *facies* digitale: «la
...
edizione critica (quali, in particolare, la *recensio* e la *collatio
...
alla *filologia* *digitale* emerge chiaramente la consapevolezza che «il
...
un nuovo approccio, che sposta l'attenzione dal testo 'ideale' (per
ricostruire il quale si individua il testimone la cui *auctoritas*, per
vari motivi, è superiore a quella degli altri testimoni) al testo
'reale'. In altre parole, la *filologia digitale* si interessa alla
individualità e alle variazioni di ogni singolo testimone, anziché
fornire un 'unificato' *textus receptus*. Come ben sintetizza Mattioda
...
ai codici di mark up*.* Il testo che il filologo dovrà preparare
...
Aa.Vv., *Accademia Nazionale dei Lincei*, Tavola rotonda sul tema
*Filologia Digitale: problemi e prospettive*, 135, Roma, Bardi Edizioni,
2017

Cotticelli Curras P., *Linguistica e filologia digitale*, Alessandria,
Edizioni dell'Orso, 2011

Fiormonte D., *Scrittura e filologia nell'era digitale*, Torino, Bollati
Boringhieri, 2003

Fiormonte D., *Note sul problema della filologia digitale*, in *Parole
online. Quale editoria e filologia nell'era digitale? -- Nuova
Informazione Bibliografica*, II, pp. 355-362,
\<[[https://infolet.it/files/2009/04/per\_rcicala4.pdf]{.underline}](https://infolet.it/files/2009/04/per_rcicala4.pdf)\>

Mattioda E., *Alcune considerazioni su filologia e testi digitali*, in
*Philologie et Politique*, 7, 2007, pp. 163-172,
\<[<http://journals.openedition.org/laboratoireitalien/143>\>]{.underline}

Mordenti R., *Filologia digitale (a partire dal lavoro per l'edizione
informatica dello Zibaldone Laurenziano di Boccaccio*, in *Humanist
Studies & the Digital Age*, 2, 1, 2012, pp. 37-56
\<[[http://journals.oregondigital.org/hsda/article/download/2991/2676]{.underline}](http://journals.oregondigital.org/hsda/article/download/2991/2676)\>

Spinazzè L., *Filologia digitale. Dalla ricerca alla didattica.
L'informatica umanistica al servizio delle scienze dell'antichità*,
Trento, Tangram Edizioni Scientifiche, 2015

## Sitografia {-}

Andrews T. L., *The third way: philology and critical edition in the
digital Age*,
\<[[https://boris.unibe.ch/43071/1/variants\_postprint.pdf]{.underline}](https://boris.unibe.ch/43071/1/variants_postprint.pdf)\> 

Giacomelli I., *Edizione digitale di fonti primarie. Elegie tirtaiche su
papiro: un esempio*, in *Griselda online -- Portale di letteratura*
(2012),
\<[[http://www.griseldaonline.it/informatica/edizione-digitale-di-fonti-primarie.html]{.underline}](http://www.griseldaonline.it/informatica/edizione-digitale-di-fonti-primarie.html)\>

\**Informatica umanistica* (*s.v*.), in *Treccani*,
\<[[http://www.treccani.it/enciclopedia/informatica-umanistica\_%28XXI-Secolo%29/](http://www.treccani.it/enciclopedia/informatica-umanistica_(XXI-Secolo)/)\>]{.underline}

Rosselli Del Turco R., *Filologia digitale: ragioni, problemi,
prospettive di una disciplina*, III incontro di filologia digitale,
Verona 3-5 marzo 2010,
\<[[http://www.dfll.univr.it/documenti/Iniziativa/dall/dall639204.pdf]{.underline}](http://www.dfll.univr.it/documenti/Iniziativa/dall/dall639204.pdf)\>

Rosselli Del Turco R., *L'edizione scientifica digitale: strumenti e
progetti*, Verona 20-21 aprile 2017,
\<[[http://filologiadigitale-verona.it/wp-content/uploads/2017/04/Introduzione-alla-Filologia-Digitale-1.pdf]{.underline}](http://filologiadigitale-verona.it/wp-content/uploads/2017/04/Introduzione-alla-Filologia-Digitale-1.pdf)\>

Tomasi F., *Le nuove frontiere della filologia*, in *Argo*, 2, 2018
\<[[http://www.argonline.it/argo/argo-n-2/argo-n-2-\_-francesca-tomasi-nuove-frontiere-filologia/]{.underline}](http://www.argonline.it/argo/argo-n-2/argo-n-2-_-francesca-tomasi-nuove-frontiere-filologia/)\>

\[*Giovanna Battaglino*\]

# FTP

(ingl. Acronimo per *File Transfert Protocol*)
...
2.  incoraggiare l\'uso indiretto o implicito di computer remoti;

3.  risolvere in maniera trasparente incompatibilità tra differenti
    sistemi di stoccaggio file tra host;

4.  trasferire dati in maniera affidabile ed efficiente.

Il protocollo utilizza delle connessioni di tipo TCP (*Transition
...
Negli anni è stata sviluppata una ulteriore versione del *FTP*,
integrandolo con un sottostrato SSL/TLS (*Secure Sockets Layer/
Transport Layer Security*) che riduce il rischio di accessi non
autorizzati alle comunicazioni client-server.

La sua logica di funzionamento è relativamente semplice: *FTP* utilizza
...
client. Attraverso il client ci si connetterà al server *FTP*
...
Poste J. - Reynolds J., *FILE TRANSFERT PROTOCOL (FTP)*,
\<[[http://www.rfc.altervista.org/rfctradotte/rfc959\_tradotta.txt]{.underline}](http://www.rfc.altervista.org/rfctradotte/rfc959_tradotta.txt)\>

\[*Alessia Marini*\]

# Gold Open Access

Si dice che una sede scientifica pubblica in *gold open access* quando i
singoli contributi di ogni autore -- una volta editi -- sono liberamente
e immediatamente disponibili online.

## Sitografia {-}

*\*Gold Open Access* (*s.v*.), in *Consiglio Nazionale delle Ricerche.
Biblioteca d'Area di Bologna*,
\<[<http://biblioteca.bo.cnr.it/index.php/it/open-access/pubblicare-oa/item/272-gold-road>\>]{.underline}

\[*Antonello Fabio Caterino*\]

# Green Open Access

Si parla di *green open access* quando l'autore contribuisce a
...
*\*Green Open Access* (*s.v*.), in *Consiglio Nazionale delle Ricerche.
Biblioteca d'Area di Bologna*,
\<[<http://biblioteca.bo.cnr.it/index.php/it/open-access/pubblicare-oa/item/271-green-open-access>\>]{.underline}

\[*Antonello Fabio Caterino*\]

# Hidden Web

L'*Hidden Web* (o Invisible Web o Deep Web o Undernet) è l'insieme delle
risorse informative del World Wide Web non indicizzate dai normali
motori di ricerca, come Google, Bing o Yahoo.

Il *Web Sommerso* nasce a scopo militare, quando nel 1969 il DARPA
(*Defense Advanced Research Projects Agency*), un'agenzia governativa
del Dipartimento della Difesa degli Stati Uniti incaricata di realizzare
nuove tecnologie, dà vita all'ARPANET (*Advanced Research Projects
...
scientifiche, fino a quando nel 1991 al CERN (*Organizzazione Europea
per la Ricerca Nucleare*) di Ginevra si definisce il protocollo HTTP
(*HyperText Transfer Protocol*), che permette la nascita del World Wide
...
(*The Onion Router*), un browser capace di garantire l'anonimato
...
1.  *Web Surface*, il livello più superficiale che comprende i siti
    facilmente accessibili e vari circuiti privati;

2.  *Deep* *Web*, a cui si accede solo tramite proxy e in cui sono
    presenti comunità di hackers, libri di qualsiasi formato e su
    qualsiasi argomento, ma anche reti internet per compagnie e
    università;

3.  *Dark* *Web*, un sottoinsieme del Deep Web, a cui è possibile
...
L'*Hidden Web* è oggi utilizzato da un'ampia gamma di persone e non solo
...
di *The Torist*, la prima rivista letteraria online pubblicata sul Deep
...
Echeverri D., *Deep Web: TOR, FreeNET & I2P: privacidad y anonimato*,
Madrid, OXWORD, 2016

Florindi E., *Deep web e bitcoin. Vizi privati e pubbliche virtù della
navigazione in rete*, Reggio Emilia, Imprimatur, 2016

Frediani C., *Deep Web. La rete oltre Google. Personaggi, storie, luoghi
dell'internet profonda*, Genova, Stampa Alternativa, 2014

Meggiato R., *Il lato oscuro della Rete: alla scoperta del Deep Web e
del Bitcoin*, Milano, Apogeo, 2014

Paganini P., *The Deep Dark Web: The Hidden World: Volume 1*, Napoli,
Apogeo, 2012

Sui D.- Caverlee J.- Rudesill D., *The deep web and the darknet: a look
inside the internet's massive black box*, Washington, Wilson Center,
2015,
\<[[https://www.wilsoncenter.org/sites/default/files/stip\_dark\_web.pdf]{.underline}](https://www.wilsoncenter.org/sites/default/files/stip_dark_web.pdf)\>

Scheeren W. O., *The hidden web. A sourcebook*, Santa Barbara, Libraries
Unlimited, 2012

Wojtowicz P., *Darknet and deep web: il lato oscuro del web per la
privacy e la protezione dati*, Tesi di Laurea, Università di Bologna,
2013/2014,
\<[<https://amslaurea.unibo.it/8456/1/wojtowicz_patryk_tesi.pdf>\>]{.underline}

## Sitografia {-}

AaVv, *Below the Surface: exploring the Deep Web*, 2015,
\<[[https://documents.trendmicro.com/assets/wp/wp\_below\_the\_surface.pdf]{.underline}](https://documents.trendmicro.com/assets/wp/wp_below_the_surface.pdf)\>

*Cybercrime in the Deep Web*,
\<[<https://www.blackhat.com/docs/eu-15/materials/eu-15-Balduzzi-Cybercrmine-In-The-Deep-Web-wp.pdf>\>]{.underline}

*Motori di ricerca scientifici*,
\<[<https://www.unipa.it/biblioteche/Cerca-una-risorsa/Motori-di-ricerca-scientifici-/>\>]{.underline}

*\*Web Sommerso* (*s.v*.), in *Wikipedia*,
\<[[https://it.wikipedia.org/wiki/Web\_sommerso]{.underline}](https://it.wikipedia.org/wiki/Web_sommerso)\>

*What is the Deep Web? A first trip into the abyss*,
\<[<http://www.aofs.org/wp-content/uploads/2013/04/130925-What-is-the-Deep-Web.pdf>\>]{.underline}
...
standard riconosciuto dal *World Wide Web Consortium* (W3C). Come SGML,
suo progenitore, e XML, l'*HTML* attua una fondamentale distinzione tra
...
basata su *HTML* il che, però, rendeva impossibile la corretta
...
3.0 del linguaggio che divenne così uno standard. Nel 1999, con l'*HTML*
...
documento *HTML*, in modo da rendere più snella la codifica alleggerendo
...
Al livello strutturale un documento *HTML* ha bisogno di una
...
e l'uso necessario di determinato marcatori, come *\<html\> \<head\>* e
*\<body\>*. A differenza del fratellastro XML, l'*HTML* non dà la
possibilità di ampliare la gamma di marcatori utilizzabili, quindi la
struttura di qualsiasi file *HTML* risulta grossomodo uguale:

1.  Inizia con *\<html\>* e deve necessariamente chiudersi con
    *\</html\>*;

2.  successivamente deve essere utilizzato il tag *\<head\>* nel quale
    vanno inserite informazioni scontate come il *\<title\>* o più
    complesse come quelle necessarie alla visualizzazione del contenuto,
    definite dal tag *\<style\>*.

3.  Chiuso l'*\</head\>* viene aperto il *\<body\>*, che rappresenta il
...
4.  Il testo viene definito da marcatori prettamente tipografici come
    *\<p\>* per i vari paragrafi o *\<h1\> \<h2\> \<h3\>* per i vari
    livelli di titolazione. All'interno del testo, poi, sarò possibile
    inserire tags come *\<i\>* per il corsivo o *\<b\>* per il
    ...
    toglie che anche nella sintassi *HTML* è possibile ritrovare
    marcatori logici come *\<em\>* (che evidenzia una porzione di testo
...
\**HTML* (*s.v*.), in *w3schools.com*,
\<[[http://www.w3schools.com/]{.underline}](http://www.w3schools.com/)\>
...
L'*Informatica umanistica* o *Digital Humanities* (anche detta
*Humanities Computing*) è un settore di ricerca interdisciplinare che
...
definisca, l'*Informatica umanistica* parte dall'indagine critica dei
...
dallo zelo di padre Roberto Busa, che nel 1949 iniziò l'[*Index
verborum*](http://www.corpusthomisticum.org/it/index.age) dell'*opera
...
settori 'tradizionali' istituzionalizzandosi e moltiplicando i centri, i
...
secondo Ramsay, è di 'costruire cose', riflettere sull'idea di
costruzione e progettare in modo tale che altri possano costruire
(Ramsay 2011a) avviando, attraverso il processo di 'building', una fase
...
l'*Informatica umanistica* e la frammentarietà delle iniziative pongono
...
portata avanti con strumenti digitali. Essa, cioè, è considerata, *sic
...
ignora invece che l'uso dell'*Informatica umanistica* ha trasformato la
ricerca dall'interno, i suoi obiettivi, l'*iter*, i suoi traguardi
qualitativi e l'espansione quantitativa e che, essendo ancora *in fieri*
...
Sicuramente lo *status* teorico dell'*Informatica umanistica* pone
...
Flanders J. - Unsworth J., *The Evolution of Humanities Computing
Centers*, in *Computers and the Humanities*, XXXVI, 4, 2002, pp. 379-380

Gold M.K., *The Digital Humanities Moment*, in Gold M. W. (a cura di),
*Debates in the Digital Humanities*, Minneapolis-London, University of
Minnesota Press, 2012, pp. IX-XVI

## Bibliografia consigliata {-}

Berry D.M., *Understanding Digital Humanities*, United Kingdom, Palgrave
Macmillan, 2012

Bodard G. - Mahony S., *Digital Research in the Arts and Humanities*,
Surrey: England, Taylor & Francis Ltd., 2010

Carter B.W., *Digital Humanities: current perspective, practices, and
research*, United Kingdom, Emerald Group Publishing Limited, 2013

Gardiner E. - Musto R.G., *The Digital Humanities*, Cambridge, Cambridge
University Press, 2015

Numerico T. - Fiormonte D. - Tomasi F., *L'umanista digitale*, Bologna,
Il Mulino, 2010

Rydberg-Cox J.A., *Digital libraries and the challenges of digital
...
Tomasi F., *Metodologie informatiche e discipline umanistiche*, Roma,
Carocci, 2008

Tomasi F. - Anselmi G.M., *Informatica e letteratura*, in *Le forme e la
storia*, 2011, IV, pp. 163 -182

Tomasi F., *Informatica Umanistica: iniziative, progetti e proposte*, in
*La macchina nel tempo. Studi di informatica umanistica in onore di Tito
Orlandi*, Firenze, Le Lettere, 2011, pp. 309 - 327

## Sitografia {-}

Buzzetti D., *Che cos'è, oggi, l'informatica umanistica? L'impatto della
tecnologia*, in Ciotti F. - Crupi G. (a cura di), *Dall'Informatica
umanistica alle culture digitali. Atti del convegno di studi (Roma,
27-28 ottobre 2011) in memoria di Giuseppe Gigliozzi*,
[[https://www.academia.edu/2305364/Che\_cos\_e\_oggi\_l\_informatica\_umanistica\_L\_impatto\_della\_tecnologia]{.underline}](https://www.academia.edu/2305364/Che_cos_e_oggi_l_informatica_umanistica_L_impatto_della_tecnologia)

Catalani L., *Informatica Umanistica e Digital Humanities*,
\<[[https://medium.com/\@luigicatalani/informatica-umanistica-e-digital-humanities-ff57c44d68be]{.underline}](https://medium.com/@luigicatalani/informatica-umanistica-e-digital-humanities-ff57c44d68be)\>

\**Informatica* (*s*.*v*.), in *Treccani*,
\<http://www.treccani.it/enciclopedia/informatica/\>

\**Informatica* *umanistica* (*s*.*v*.), in *Wikipedia*,
\<https://it.wikipedia.org/wiki/Informatica\_umanistica\>

Monella P., *L'informatica umanistica tra istituzionalizzazione e
strumentalismo*,
[[http://www1.unipa.it/paolo.monella/lincei/files/where/strumenti\_v2.0.pdf]{.underline}](http://www1.unipa.it/paolo.monella/lincei/files/where/strumenti_v2.0.pdf)

\**Umanistico* (*s*.*v*.), in *Treccani*,
[[http://www.treccani.it/vocabolario/umanistico/]{.underline}](http://www.treccani.it/vocabolario/umanistico/)
...
computer. Ogni *interfaccia utente* (UI) è unica e legata alla funzione
che deve svolgere ma tutte hanno in comune certi elementi di base. Una
buona *UI* deve essere user-friendly e quindi permettere un'esperienza
d'utilizzo naturale ed intuitiva che non frustri l'utente. Lo sviluppo
delle *UI* ha avuto inizio a partire dalla seconda metà del XX secolo;
si può considerare il sistema di schede forate dei primi computer come
la prima elaborazione di una *UI*. Ad oggi, dopo decenni di sviluppo nel
campo dell'informatica si è passati dalle *Text-Based UI* alle
*Graphical User Interface* (GUI) che permettono una navigazione
semplificata all'interno dei software.

Un'interfaccia è composta da un set di comandi, o menù, attraverso i
quali si riesce a comunicare con il programma software. Una *UI*
*command-driven* richiede che l'utente inserisca direttamente i comandi;
una *menu-driven* permette un sistema di selezione dei comandi
attraverso dei menù che compaiono a schermo.

Tra le *menu-driven UI* si trovano le cosiddette GUI. Si tratta infatti
...
\**User Interface* (*s.v*.), in *Tech* *Terms*,
\<[[https://techterms.com](https://techterms.com/)\>]{.underline}

\**User Interface* (*s.v*.), in *webopedia*,
\<[[https://www.webopedia.com/TERM/U/user\_interface.html]{.underline}](https://www.webopedia.com/TERM/U/user_interface.html)\>

\[*Antonio Marson Franchini*\]

# Machine learning

Il *Machine Learning* (ML) -- in italiano Apprendimento Automatico -- è
...
termine *Machine Learning* fu un noto scienziato americano e pioniere
...
*Machine Learning* migliorano le loro prestazioni mediante l'esperienza
...
1.  L'apprendimento supervisionato (o *Supervised Learning*) consiste
...
2.  L'apprendimento non supervisionato (o *Unsupervised Learning***)**
...
-   raggruppamento (o *clustering*), quando occorre raggruppare dati che
...
3.  L'apprendimento semi-supervisionato (o *Semi-Supervised Learning*)
...
4.  L'apprendimento per rinforzo (o *Reinforcement
    Learning***)** rappresenta il sistema di apprendimento più
...
Ci sono poi altre sottocategorie di *Machine Learning*, tra cui il Deep
Learning (o Apprendimento Profondo), che usa [reti
neurali](https://www.ai4business.it/intelligenza-artificiale/deep-learning/reti-neurali/) --
...
Molti settori riconoscono oggi il valore del *Machine Learning* grazie
...
Alpaydin E., *Introduction to Machine Learning*, Cambridge, Mit Press,
2009

Bishop C.M., *Pattern recognition and Machine Learning*, Singapore,
Springer Verlag, 2006

Chapelle O. - Shölkopf B. - Zien A., *Semi-Supervised Learning*,
Cambridge (MA), Mit Press, 2006

Goutte G. *et al*., *Learning machine translation*, Cambridge (MA), Mit
Press Ldt., 2009

Harrington P., *Machine Learning in action*, New York, Manning
Publications, 2012

Holmes D.E. - Jain L.C., *Innovations in Machine Learning. Theory and
applications*, The Nethedlands, Springer, 2006

Kononenko I. - Kukar M., *Machine Learning and Data Mining: Introduction
to principles and algorithms*, United Kingdom, Horwood Publishing
Chichester, 2007

Marsland S., *Machine Learning: an algorithmic perspective*, Cambridge,
Chapman and Hall/CRC, 2009

Powers D.M.W. - Turk C.C.R., *Machine Learning of natural language*,
London, Springer, 1989

Sammut C. - Webb G.I., *Encyclopedia of Machine Learning*, New York,
Sammut, 2011

Sebe N. *et al*., *Machine Learning in Computer vision*, The
...
\**Apprendimento Automatico* (*s*.*v*.), in *Wikipedia*,
\<[[https://it.wikipedia.org/wiki/Apprendimento\_automatico]{.underline}](https://it.wikipedia.org/wiki/Apprendimento_automatico)\>

Mitchell T.M., *Machine Learning*, Maidenhead 1997,
\<[[https://www.cs.ubbcluj.ro/\~gabis/ml/ml-books/McGrawHill%20-%20Machine%20Learning%20-Tom%20Mitchell.pdf]{.underline}](https://www.cs.ubbcluj.ro/~gabis/ml/ml-books/McGrawHill%20-%20Machine%20Learning%20-Tom%20Mitchell.pdf)\>

Nilsson N.J., *Introduction to Machine Learning. An early draft of a
proposed textbook*, Stanford 1998
\<[[https://ai.stanford.edu/\~nilsson/MLBOOK.pdf]{.underline}](https://ai.stanford.edu/~nilsson/MLBOOK.pdf)\>

Shai S.S.-Shai B.D., *Understanding Machine Learning. From theory to
algorithms*, USA 2014
\<[[https://www.cs.huji.ac.il/\~shais/UnderstandingMachineLearning/understanding-machine-learning-theory-algorithms.pdf]{.underline}](https://www.cs.huji.ac.il/~shais/UnderstandingMachineLearning/understanding-machine-learning-theory-algorithms.pdf)\>

Stefenelli M., *Apprendimento automatico nei giochi di strategia*, Tesi
di Laurea, Università di Bologna Campus di Cesena, 2013/2014
\<[<https://amslaurea.unibo.it/7660/1/TESI_Marco_Stefenelli.pdf>\>]{.underline}
...
si contrappone al WYSIWYG (*What You See Is What You Get*) e, per via
...
I linguaggi di *markup* sono lo strumento standard per lo sviluppo di
oggetti digitali. Il capostipite di questi linguaggi è SGML (*Standard
Generalized Markup Language*) creato nel 1986 da Charles Goldfarb e
risultato tanto funzionale da diventare lo standard ISO (*International
Standard Organization*) per la codifica dei testi. Ad oggi, nell'ambito
dell'informatica umanistica lo standard è il linguaggio di *markup* TEI
(*Text Encoding Initiative*) basato sullo standard XML (*eXstensible
Markup Language*).
...
Con il termine *metadato*, mutuato dall'inglese *metadata* -- costituito
dal greco μετὰ (*meta:* oltre, dopo) e dal plurale neutro latino *data*,
...
forma singolare *metadato* (ricavata all'interno del sistema morfologico
italiano) è di utilizzazione più infrequente.

I *metadati* sono legati al ciclo di vita di una risorsa digitale nel
...
I *metadati* sono quindi informazioni strutturate che descrivono,
...
informative e *metadati*, oltre ad essere indispensabili, si prestano a
svariate declinazioni: i *metadati* possono essere statici o dinamici;
'embedded' -- ossia inclusi nella risorsa come parte integrante -- o
...
schemi di *metadati* come diversi e più oggetti possono essere associati
tra loro attraverso *metadati*. Inoltre, il ciclo di vita di una risorsa
digitale deve essere accompagnato dal costante aggiornamento del
*corpus* dei relativi metadati, affinché tutto quanto accade resti
tracciato e documentato.

La comunità scientifica internazionale, preso atto della necessità di
associare alle entità digitali un insieme di *metadati* con i caratteri
...
1.  *metadati descrittivi* (*descriptive metadata*)*:* finalizzati
    ...
    dei sistemi di *Information Retrieval* all'esterno degli archivi
    degli oggetti digitali e sono collegati a questi ultimi con link
    dedicati;

2.  *metadati strutturali* (*structural metadata*): volti a descrivere
...
3.  *metadati amministrativo-gestionali*, funzionali alla gestione degli
...
*metadati* per la gestione dei diritti, i *metadati* per la security, i
*metadati* per le informazioni personali, i *metadati* per la
...
*metadati* di valenza descrittiva è lo standard *ISO 15836*, comunemente
noto come *Dublin Core (DC, in realtà Dublin Core Metadata Initiative,
DCMI)*.

Il *Dublin Core* è un insieme di *metadati*, poi implementato,
...
di integrarsi con altri standard di *metadati*, anche all'interno di una
...
1.  *Metadata Object Description Schema* (MODS): schema di *metadati*
...
2.  *Metadata Encoding and Trasmission Standard* (METS): standard per la
    codifica dei *metadati* descrittivi, amministrativi e strutturali di
    un oggetto digitale. Un documento METS è caratterizzato da ampia
    compatibilità con gli altri schemi di *metadati* e ciò rende questo
    standard particolarmente flessibile e applicabile in diversi
    contesti;

3.  *Metadati Amministrativi e Gestionali* (MAG): il progetto sotteso è
    finalizzato all'elaborazione, al mantenimento e all'evoluzione di
    uno standard italiano di *metadati* amministrativi e gestionali. Il
...
4.  *Open Archival Information System* (OAIS, standard ISO 14721): il
...
5.  *Preservation Metadata: Implementation Strategies* (PREMIS): si
    tratta dello standard più utilizzato per i *metadati* di
...
digitale e i *metadati* che ne rappresentano le caratteristiche, nonché
il ruolo che i *metadati* svolgono nelle diverse fasi di vita della
...
determinato la creazione. La scelta degli standard di *metadati* da
...
Crupi G., *Bibloteca digitale*, in Solimine G. - Weston P.G. (a cura
di), *Biblioteche e biblioteconomia. Principi e questioni*, Roma,
Carocci, 2015, pp. 373-417

Feliciati P., *Gestione e conservazione di dati e metadati per gli
archivi: quali standard?*, in Pigliapoco S. (a cura di), *Conservare il
digitale*, Macerata, EUM, 2010, pp. 191-219

Feliciati P., *I metadati nel ciclo di vita dell\'archivio digitale e
l\'adozione del modello PREMIS nel contesto applicativo nazionale*, in
Bonfiglio Dosio G. - Pigliapoco S. (a cura di), *Formazione, gestione e
conservazione degli archivi digitali. Il Master FGCAD dell\'Università
degli Studi di Macerata*, Macerata, EUM, 2015, pp. 189-208

Franzese P., *Manuale di archivistica italiana*, Perugia, Morlacchi
Editore U.P., 2014

Guercio M., *Archivistica informatica: i documenti in ambiente
digitale*, Roma, Carocci, 2013

Guercio M., *Conservare il digitale. Principi, metodi e procedure per la
conservazione a lungo termine di documenti digitali*, Roma-Bari,
Laterza, 2013

Guercio M., *La conservazione delle memorie digitali*, in Solimine G. -
Weston P.G. (a cura di), *Biblioteche e biblioteconomia. Principi e
questioni*, Roma, Carocci, 2015, pp. 545-566

Michetti G., *Gli standard per la gestione documentale*, in Giuva L. -
Guercio M., *Archivistica. Teorie, metodi, pratiche*, Roma, Carocci, 2014, pp. 263-286

Pigliapoco S., *Progetto archivio digitale. Metodologia sistemi
professionalità*, Lucca, Civita editoriale, 2016

Weston P.G. - Sardo L., *Metadati*, Roma, Associazione Italiana
Biblioteche, 2017

## Sitografia {-}

*Data Dictionary for preservation Metadata*, 3, 2015,
\<[[www.loc.gov/standards/premis/v3/premis-3-0-final.pdf](http://www.loc.gov/standards/premis/v3/premis-3-0-final.pdf)\>]{.underline}

*Linee guida per la digitalizzazione e metadati*, in *ICCU -- Istituto
Centrale per il Catalogo Unico, delle Biblioteche italiane e per le
informazioni bibliografiche*,
**\<**[<http://www.iccu.sbn.it/opencms/opencms/it/main/standard/metadati>\>]{.underline}

*METS -- Metadata Encoding & Transmission Standard*,

\<[[www.loc.gov/standards/mets/METSita.html]{.underline}](http://www.loc.gov/standards/mets/METSita.html)\>

Pierazzo E. (a cura di), *MAG -- Metadati Amministrativi e Gestionali.
Manuale Utente*,

\<[<http://www.iccu.sbn.it/upload/documenti/Manuale.pdf>\>]{.underline}

*Metadata Object Description Schema,*
\<[[http://www.loc.gov/standards/mods/]{.underline}](http://www.loc.gov/standards/mods/)\>

\**OAIS Reference Model*, in *Conservazione Digitale. Centro di
eccellenza italiano sulla Conservazione Digitale*,
\<[<http://www.conservazionedigitale.org/wp/approfondimenti/depositi-di-conservazione/oais-reference-model>\>]{.underline}

\[*Concetta Damiani*\]

# N-gramma

*N-gramma* è una nozione matematica concettualmente semplice: data una
sequenza ordinata di elementi, un *n-gramma* ne rappresenta una
sottosequenza di n elementi. Ma le applicazioni di questo concetto
matematico, da cui è possibile elaborare modelli (*n-gram models*), sono
...
(settore interdisciplinare prima ancora che 'scienza' a sé: cfr.
Tamburini 2008) *et alia*. In particolare, in campo linguistico, un
*n-gramma* è una sequenza di due (bi-gramma), tre (tri-gramma) o più
(n-gramma) parole-chiave presenti all'interno di un dato, specifico
contesto; più semplicemente, si potrebbe affermare che gli *n-grammi*
sono 'gruppi' di parole che compaiono insieme in un testo.

L'uso degli *n-grammi* si rivela molto utile, ad esempio, nel calcolo
delle co-occorrenze, il che -- in altri termini -- consente di lavorare
sulla intertestualità. Il calcolo delle co-occorrenze tramite *n-grammi*
non tiene conto dei seguenti elementi: 1. presenza di segni di
interpunzione; *stop-words* (cioè parole semanticamente vuote e o parole
che, essendo comuni, se isolate, non restituiscono un particolare
significato); 3. *ordo verborum*. Per fornire un esempio concreto, che
coniughi il concetto di *n-grams* e le digital humanities, basterà
chiamare in causa, ancora una volta, quello straordinario strumento che
è il TLG, che dispone della specifica, interessante funzione *N-grams*
...
considerazione della loro *brevitas*), consente di individuare
...
*N-Grams*, il TLG consente di 'sfruttare' gli *N-Grams* anche
...
e l'intero *corpus* del TLG (nel caso di accesso al *full corpus*).

Tra le numerose applicazioni linguistico-filologiche degli *n-grammi*,
...
presenza, la frequenza e la distribuzione di specifici *n-grammi*
accuratamente individuati e selezionati (cfr., a tal proposito, per la
letteratura italiana: Basile-Lana 2008; Basile *et alii* 2008; Boschetti
2018; per la letteratura greca: Gorman-Gorman 2016; per una panoramica
generale e concisa: Battaglino 2018). Gli *n-grammi* possono essere
...
*n-grammi*. A tal proposito, si rimanda all'interessante e recente
...
2013), «Google has created a database of *n*-grams extracted from these
...
Basile C. - Benedetto D. - Caglioti E. - Degli Esposti M., *An example
of mathematical authorship attribution*, in *Journal of Mathematical
Physics*, 49, 2008, pp. 2-20,
\<[[https://www.researchgate.net/publication/228663468\_An\_example\_of\_mathematical\_authorship\_attribution]{.underline}](https://www.researchgate.net/publication/228663468_An_example_of_mathematical_authorship_attribution)\>

Basile C. - Lana M., *L'attribuzione di testi con metodi quantitativi:
riconoscimento di testi gramsciani*, in *AIDA Informazioni* , 1-2, 2008,
pp. 165-183,
\<[[https://www.academia.edu/6604207/Lattribuzione\_di\_testi\_con\_metodi\_quantitativi\_riconoscimento\_di\_testi\_gramsciani]{.underline}](https://www.academia.edu/6604207/Lattribuzione_di_testi_con_metodi_quantitativi_riconoscimento_di_testi_gramsciani)\>

Battaglino G., *La tessitura matematica dei testi. Filologia e metodi
matematico-statistici: l'auspicabile* σύγκρισις *tra metodi qualitativi
e metodi quantitativi*, in *FRI -- Filologia Risorse Informatiche*
(*Carnet de recherche and online journal -- Italian Digital
Humanities*),
\<[[https://fri.hypotheses.org/915]{.underline}](https://fri.hypotheses.org/915)\>
...
Boschetti F., *Copisti digitali e filologi computazionali*, Roma, CNR
Edizioni, 2018,
\<[[http://eprints.bice.rm.cnr.it/17545/1/bookBoschetti2018.pdf]{.underline}](http://eprints.bice.rm.cnr.it/17545/1/bookBoschetti2018.pdf)\>

Caterino A.F., *Note minime su* Google Books, in *FRI -- Filologia
Risorse Informatiche* (*Carnet de recherche and online journal --
Italian Digital Humanities*),
\<[[https://fri.hypotheses.org/128]{.underline}](https://fri.hypotheses.org/128)\>

Gorman V. B. - Gorman R. J., *Approaching Questions of the Text Reuse in
Ancient Greek using Computational Syntactic Stylometry*, in *Open
Linguistic*, 2, 2016, pp. 500-510,
\<[[https://www.degruyter.com/downloadpdf/j/opli.2016.2.issue-1/opli-2016-0026/opli-2016-0026.pdf]{.underline}](https://www.degruyter.com/downloadpdf/j/opli.2016.2.issue-1/opli-2016-0026/opli-2016-0026.pdf)\>

Knight G. P. - Tabrizi N., *Using n-Grams to Identify Time Periods of
Cultural Influence*, in *Journal on Computing and Cultural Heritage*, 9,
3, 2016, art. n. 15, pp. 1-19,
\<[[https://dl.acm.org/citation.cfm?id=2940332]{.underline}](https://dl.acm.org/citation.cfm?id=2940332)\>

Tamburini F., *La linguistica computazionale: un crogiolo di esperienze
multidisciplinari*, in *GRISELDAONLINE* , 2008, pp. 1-11,
\<[[http://www.griseldaonline.it/informatica/la-linguistica-computazionale-tamburini.html]{.underline}](http://www.griseldaonline.it/informatica/la-linguistica-computazionale-tamburini.html)\>

## Sitografia {-}

\**Google Ngram Viewer* (*s.v.*), in *Wikipedia* (EN),
\<[[https://en.wikipedia.org/wiki/Google\_Ngram\_Viewer]{.underline}](https://en.wikipedia.org/wiki/Google_Ngram_Viewer)\>

\**Intertestualità* (*s.v.*), in *Treccani*,
\<[[http://www.treccani.it/vocabolario/intertestualita/]{.underline}](http://www.treccani.it/vocabolario/intertestualita/)\>

\* *N-gram* (*s.v*.), in *Wikipedia* (EN),
\<[[https://en.wikipedia.org/wiki/N-gram]{.underline}](https://en.wikipedia.org/wiki/N-gram)\>

\**N-gramma* (*s.v.*), in *Wikipedia,*
\<[[https://it.wikipedia.org/wiki/N-gramma]{.underline}](https://it.wikipedia.org/wiki/N-gramma)\>

\**Stop words* (*s.v.*), in *Wikipedia* (EN),
\<[[https://en.wikipedia.org/wiki/Stop\_words]{.underline}](https://en.wikipedia.org/wiki/Stop_words)\>
...
Si definisce *oggetto digitale* qualsiasi testo, documento, immagine,
...
operazioni gestionali. L'*oggetto digitale* può nascere direttamente
...
di specificazione che la distingue in 'oggetti digitali semplici' e
'complessi'*.* Secondo il glossario della California Digital Library, i
...
L'*oggetto digitale* possiede inoltre come caratteristica la difficoltà
...
digitale. È per questi due motivi che l'*oggetto* *digitale* deve essere
affrontato come: 'oggetto fisico'*, '*oggetto logico'*, '*oggetto
concettuale'*, '*collezione di elementi'. Tutti questi aspetti devono
essere tenuti in considerazione all'atto di creazione dell'*oggetto
...
Numerico T.- Vespignani A., *Informatica per le scienze umanistiche*,
Bologna, Il Mulino, 2003

Fiormonte D. - Numerico T. - Tomasi F., *L'umanista digitale*, Bologna,
Il Mulino, 2010

Sebastiani M., *Il "documento digitale": analisi di un concetto in
evoluzione*, in *DigItalia*. *Rivista del digitale nel beni culturali*,
1, 2008, pp. 9-31

## Sitografia {-}

\**Digital Wrapper*, in *CDL -- California Digital Library's Glossary*,
\<[[http://www.cdlib.org/gateways/technology/glossary.html?field=glossary&action=search&query=oac\#d]{.underline}](http://www.cdlib.org/gateways/technology/glossary.html?field=glossary&action=search&query=oac#d)\>
...
*Ontologia* è un termine mutuato dalla filosofia, che in informatica
assume il significato di 'rappresentazione di una forma di conoscenza o
parte del mondo' da modellare in un programma (dominio). Nei sistemi di
condivisione della conoscenza, l'*ontologia* ha il compito di
rappresentare 'le cose che esistono' in un determinato dominio
...
(specificazione). Le *ontologie* sono importanti per il Web Semantico,
...
Esempio: Clavius (*Istituto di Linguistica Computazionale Zampolli di
...
concetti (terminologia ed entità di dominio) formano un'*ontologia*
...
*OPAC*, acronimo di *Online public access catalogue* (o catalogo in
linea ad accesso pubblico). Se le prime biblioteche digitalizzate erano
consultabili soltanto tramite 'telnet' -- un protocollo di rete molto
diffuso prima dell'espansione di Internet --, oggi sono accessibili
direttamente dal Web.

La consultazione di un *OPAC* avviene mediante la compilazione di uno o
...
Si distinguono varie tipologie di *OPAC*:

1.  *OPAC* di singole biblioteche, che occorre consultare mediante il
    link della biblioteca;

2.  *OPAC* collettivi, ossia cataloghi online che contengono i database
...
3.  multi -- e meta -- *OPAC*, che interrogano più cataloghi online già
    ...
    sono in grado di interrogare più *OPAC* mediante una sola richiesta,
    e di restituire i risultati dei diversi *OPAC* coperti. Un esempio
    italiano di metaopac è il MAI (*Metaopac Azalai Italiano*),
    [[http://www.aib.it/progetti/opac-italiani/mai-ricerca-globale/]{.underline}](http://www.aib.it/progetti/opac-italiani/mai-ricerca-globale/).

Per facilitare la ricerca alcune pagine Web raccolgono link di *OPAC*,
sia italiani che stranieri (ad esempio il *Gateway to Library Catalogs*:
[[https://www.loc.gov/z3950/gateway.html]{.underline}](https://www.loc.gov/z3950/gateway.html)),
nei quali sono contenuti un gran numero di cataloghi. Tra questi vi è
l'italiano *OPAC SBN* (*Servizio Bibliotecario Nazionale*), ossia una
rete di biblioteche italiane promossa dal MiBAC, dalle Regioni e dalle
Università, organizzata dall'ICCU (*Istituto Centrale per il Catalogo
Unico*), che interroga più biblioteche contemporaneamente (cfr. OPAC
collettivi).

I vantaggi ottenuti dall'introduzione degli *OPAC* sono dunque evidenti.
Essi:

1.  aiutano a trovare rapidamente i documenti presenti nelle
    biblioteche;

2.  consentono di conoscere la disponibilità di un documento in tempo
    reale;

3.  permettono la prenotazione di un libro;

4.  consentono l'accesso a versioni elettroniche di documenti cartacei,
...
conferendo all'*OPAC* un ruolo di imprescindibile utilità e
promuovendolo a necessario strumento delle Digital Humanities.

## Bibliografia consigliata {-}

Dhanavandan S. - Isabella Mary A., *Online public access catalague
(OPAC)*, New Delhi, Write and Print publications, 2015

IFLA, *Guidelines for online public access catalogue (OPAC) displays*,
in *Series on Bibliographic Control*, 27, 2005

Nelson Bonnie R., *Opac Directory 1998: a guide to Internet-Accessible
online public access catalogs*, Medford (NJ), Information Today Inc.,
1997

Tramullas J. - Garrido P., *Library automation and OPAC 2.0: information
access and services in the 2.0 landscape*, Hershey (PA), Information
Science Reference, 2012

## Sitografia {-}

*AIB Web*, *Il Web dell'Associazione Italiana Biblioteche*: *MAI*,
\<[<http://www.aib.it/progetti/opac-italiani/mai-ricerca-globale/>\>]{.underline}

*Gateway to Library Catalogs*,
\<[<https://www.loc.gov/z3950/gateway.html>\>]{.underline}

Gnoli Claudio, *Opac in Italia: una panoramica delle tipologie e delle
modalità di consultazione*,
[[http://www.aib.it/aib/sezioni/emr/bibtime/num-ii-1/gnoli.htm\#nota1]{.underline}](http://www.aib.it/aib/sezioni/emr/bibtime/num-ii-1/gnoli.htm#nota1)

\**OPAC* (*s.v*.), in *Wikipedia*,
\<[<https://it.wikipedia.org/wiki/OPAC>\>]{.underline}

*OPAC SBN*, *Catalogo del Servizio Bibliotecario Nazionale*,
\<[<https://opac.sbn.it/opacsbn/opac/iccu/informazioni.jsp>\>]{.underline}

\**Telnet* (*s.v*.), in *Wikipedia*,
\<[<https://it.wikipedia.org/wiki/Telnet>\>]{.underline}

\[*Alessandra Di Meglio*\]

# Open Access

*Open Access* (OA) è il termine comunemente utilizzato per indicare un
...
dell\'*OA* è riguadagnare possesso della comunicazione scientifica,
offrendo libero accesso ai risultati della ricerca.

La letteratura *Open Access* (OA) è digitale, online, gratuita e libera
...
Nel 2004 la *Conferenza dei Rettori delle Università Italiane* (CRUI) ha
formalizzato l\'adesione alla *Dichiarazione di Berlino* con la
*Dichiarazione di Messina,* Documento italiano a sostegno della
...
Di Donato F., *La scienza e la rete. L\'uso pubblico della ragione
nell\'età del web*, Firenze, Firenze University Press, 2009

## Sitografia {-}

Suber P., *Breve introduzione all\'accesso aperto*, traduzione italiana
di Susanna Mornati, 2004,
\<[[http://www.iss.it/binary/bibl/cont/Suber.1110468892.pdf]{.underline}](http://www.iss.it/binary/bibl/cont/Suber.1110468892.pdf)\>
...
Il concetto di *paratesto* appartiene alla teoria della letteratura e fu
introdotto dal critico francese Gérard Genette. Secondo il Vocabolario
della Lingua Italiana Garzanti il *paratesto* è l'insieme degli elementi
...
il termine deriva dal francese *paratexte* ed indica l'insieme di
...
Genette teorizza la nozione di *paratesto* in *Seuils*, Paris, Seuil,
1987 (edizione italiana a cura di Camilla Maria Cederna, Soglie. I
dintorni del testo, Torino, Einaudi, 1989).

*Etimologia*

Secondo il Vocabolario on-line Treccani il termine *paratesto* è formato
dalla preposizione greca *para-* ('vicino', 'affine', 'contrapposto') e
dal sostantivo *testo* (dal latino *textus*, tessuto, da *texere*,
tessere, intrecciare) sul modello del francese *paratexte*.

*Parti*

Il genere *paratesto* viene suddiviso in base alla sua ubicazione in
*peritesto* ed *epitesto*.

*Peritesto*

Il *peritesto* si trova nello spazio dell\'opera, con una funzione
paratestuale quasi esclusivamente di presentazione, di indirizzo e di
commento. È il nucleo del *paratesto*, ha forma e, generalmente,
...
Appartengono al genere *peritesto* anche gli elementi direttamente
dipendenti dall\'editor[e](https://it.wikipedia.org/wiki/Editore): il
...
sono indicati l'autore, il titolo, le note tipografiche), il *colophon*
nelle pagine finali (nei libri moderni la formula 'finito di stampare'
...
*peritesti* anche il nome dell'autore, il titolo dell'opera, le dediche
...
sezioni), le note. Infine, è considerato *peritesto* il cosiddetto
*prière d'insérer*, *paratesto* della consuetudine editoriale francese,
...
L\'*epitesto* è qualsiasi elemento paratestuale non contiguo, ma
...
L'*epitesto* si distingue in pubblico e privato. Appartengono al primo
genere l'*epitesto* editoriale con funzione promozionale (pubblicità,
inserzioni), l'allografo ufficioso (recensioni, interventi critici),
l'*epitesto* autonomo (le risposte e i commenti pubblici dell\'autore) o
mediatizzato (interviste, convegni, occasioni pubbliche di rapporto con
l'autore).

L'*epitesto* privato è rivolto ad una persona, che si interpone tra
l'autore e il pubblico e può essere un corrispondente, un confidente o
anche l'autore stesso. L'*epitesto* privato si suddivide in
confidenziale, quando è rivolto a un confidente, ed intimo, se il
destinatario è l'autore stesso.

*Teoria retorica*

In *Der humanistische Geleittext als Paratext -- am Beispiel von Brants
Beigaben zu Tennglers* Layen *'*Spiegel' Joachim Knape include nel
*paratesto* il testo di presentazione umanistico, che aumenta il valore
del testo introdotto. A nostro parere confermano questa interpretazione
per esempio anche le lettere dedicatorie erasmiane del *De copia
verborum ac rerum*.

In *Powerpoint in rhetoriktheoretischer Sicht* Knape analizza la
...
*paratesto* oppure come testo centrale. In quanto *paratesto*, funge da
...
Knape J., *Der humanistische Geleittext als Paratext -- am Beispiel von
Brants Beigaben zu Tennglers* Layen Spiegel, in Deutsch A. (Hg.),
*Ulrich Tenglers Laienspiegel. Ein Rechtsbuch zwischen Humanismus und
Hexenwahn*, Heidelberg, Blaukreuz-verlag, 2011, pp. 117-138

Knape J., *Powerpoint in rhetoriktheoretischer Sicht*, in Bernt
Schnettler, Knoblauch H. (Hg.), *Powerpoint-Präsentationen. Neue Formen
der gesellschaftlichen Kommunikation von Wissen*, Konstanz, UVK
Verlagsgesellschaft mbH, 2007

Zingarelli N., *Lo Zingarelli 1995. Vocabolario della lingua italiana di
Nicola Zingarelli*, *Dodicesima edizione a cura di Mirco Dogliotti e
Luigi Rosiello*, Bologna, Zanichelli, 1995

## Sitografia {-}

\**Paratesto* (*s.v*.), in *Garzanti Linguistica*,
\<[<http://www.garzantilinguistica.it/ricerca/?q=paratesto>\>]{.underline}

\**Paratesto* (*s.v*.), in *Treccani*,
\<[[http://www.treccani.it/vocabolario/paratesto/]{.underline}](http://www.treccani.it/vocabolario/paratesto/)\>
...
combinazione con MySql. Il *PHP* è un linguaggio di scripting, con cui
...
Script). Come molti linguaggi di scripting, *PHP* necessita di un
interprete, affinché la macchina comprenda le istruzioni contenute nel
codice in *PHP*. Nel momento in cui installiamo *PHP* dal sito
...
L'uso di *PHP* quindi comprende la realizzazione di script a riga di
...
*PHP* è un linguaggio open-source (vd. Open-source), attualmente alla
...
Nelle DH, *PHP* è uno dei linguaggi più comuni per la creazione di
...
sviluppato in *PHP* e MySql su server Apache. Si tratta di una banca
...
La *Public History* si occupa di definire e organizzare scientificamente
...
Nel nostro Paese la disciplina mutua la forma anglosassone di *Public
...
*National Council on Public History* - e l'intento di sottolineare il
...
«In Italia sono inoltre imprescindibili per la *Public History* sia la
...
*Manifesto della Public History italiana* (2018).

L\'esordio ufficiale della *Public History* nel panorama universitario
italiano è datato al settembre 2013, con un seminario dedicato
nell'ambito dei "Cantieri di Storia" promossi dalla SISSCO presso
...
costitutiva dell'*Associazione Italiana di Public History*, motore di
numerose iniziative di studio, ricerca, interazione e comunicazione.

La disciplina è volta a promuovere un rinnovato "senso pubblico" della
...
conflittuale delle memorie. Il *public historian* deve quindi essere una
...
dai *public historians* per la costruzione e la comunicazione pubblica
del passato, un ruolo strategico va attribuito alla *Digital Public
History*, che favorisce la valorizzazione di contenuti generati dagli
utenti e pratiche di crowdsourcing. Il processo di
internazionalizzazione della *Public History trova un punto di forza
nello strutturarsi di pratiche 'glocali' favorite dal digitale.* I nuovi
mondi digitali, infatti, hanno contribuito a moltiplicare i cosiddetti
"creatori di storia", rendendo virtualmente qualunque individuo capace
...
l'indispensabilità di un costante impegno "pubblico" di accademici e
...
Noiret S., *La "Public History": una disciplina fantasma?,* in Noiret S.
(a cura di), *Public History. Pratiche nazionali e identità globale*, in
*Memoria e Ricerca, Rivista di storia contemporanea*, n. 37,
maggio-agosto 2011, pp. 10-35

Noiret S., *Storia pubblica digitale*, in *Zapruder*, n. 36,
gennaio-aprile 2015, pp. 8-23

## Bibliografia consigliata {-}

Bertella Farnetti P. - Bertuccelli L. - Botti A. (a cura di), *Public
History. Discussioni e pratiche*, Milano-Udine, Mimesis, 2017

Noiret S. (a cura di), *Musei di storia e Public History,* in *Memoria e
Ricerca, Rivista di storia contemporanea,* n. 1, gennaio-aprile 2017

Ridolfi M., *Verso la Public History. Fare e raccontare storia nel tempo
presente*, Pisa, Pacini, 2017

## Sitografia {-}

*Il manifesto della Public History Italiana*, in *AIPH* - *Associazione
Italiana Public History*,
\<[[https://aiph.hypotheses.org/3193]{.underline}](https://aiph.hypotheses.org/3193)\>

Sini G. (a cura di), *Scienze umane, dalla produzione di nuova
conoscenza alla disseminazione e ritorno*, in *RiMe. Rivista
dell'Istituto di Storia dell'Europa Mediterranea*, 1/I n.s., dicembre
2017, DOI:
\<[[https://doi.org/10.7410/1287]{.underline}](https://doi.org/10.7410/1287)\>
...
Il processo di *Self-archiving* (o autoarchiviazione o Green Road)
...
termine *self-archiving* è stato proposto in ambito universitario da
Stevan Harnad nel 1994, in *Subversive Proposal*, pubblicato nel 1995
...
1.  Open Archive istituzionali: l'archivio raccoglie tutti i lavori di
...
2.  Open Archive disciplinari: come ArXiv (contenente in larga parte
...
1.  OpenDOAR (*Directory Access Repositories*): un repertorio di oltre
    2000 Repository ricercabile per area disciplinare, lingua, nazione,
    software utilizzato, etc.

2.  ROAR (*Registry od Open Access Repositories*): un registro di oltre
    2000 Repository ricercabili per nazione, tipo di Repository e
    software;

3.  PLEIADI: portale per la letteratura scientifica elettronica italiana
...
archiviazione e consultare la banca dati SHERPA/RoMEO *Publisher
...
([[https://www.researchgate.net/about]{.underline}](https://www.researchgate.net/about))
e Academia.edu
([[https://www.academia.edu/about]{.underline}](https://www.academia.edu/about)),
...
Come dice Stevan Harnad in *Subversive* *Proposal*: «i costi elevati
...
Delle Donne R., *Studi e ricerche di scienze umane e sociali*, Napoli,
fedOA Press, 2014

De Robbio A., *Archivi aperti e comunicazione scientifica*, Napoli,
ClioPress, 2007
...
\<[[https://repository.lib.ncsu.edu/bitstream/handle/1840.2/83/antelman\_self-archiving.pdf?sequence=1&isAllowed=y]{.underline}](https://repository.lib.ncsu.edu/bitstream/handle/1840.2/83/antelman_self-archiving.pdf?sequence=1&isAllowed=y)\>

\**Autoarchiviazione* (*s.v*.), in *Wikipedia*
\<[[https://it.wikipedia.org/wiki/Autoarchiviazione]{.underline}](https://it.wikipedia.org/wiki/Autoarchiviazione)\>

Brody T. *et* *al*., *The effect of Open Access on citation impact*,
\<[[http://opcit.eprints.org/feb19oa/brody-impact.pdf]{.underline}](http://opcit.eprints.org/feb19oa/brody-impact.pdf)\>

De Robbio A., *Auto-archiviazione per la ricerca: problemi aperti e
sviluppi futuri*,
\<[[file:///C:/Users/Utente/Downloads/Auto-archiviazione\_per\_la\_ricerca\_problemi\_aperti\_.pdf]{.underline}](file:///C:/Users/Utente/Downloads/Auto-archiviazione_per_la_ricerca_problemi_aperti_.pdf)\>

Eberechukwu Eze M. - Chukwuma Okeji C. - Ejiobi Bosah G.,
*Self-Archiving options on social networks: a review of options*,
[[file:///C:/Users/Utente/Downloads/Self-archivingonsocialmedia.pdf]{.underline}](file:///C:/Users/Utente/Downloads/Self-archivingonsocialmedia.pdf)

Gadd E. A. -- Troll Covey D., *What does "green" open access mean?
Tracking twelve years of changes to journal publisher self-archiving
policies*,
\<[[https://dspace.lboro.ac.uk/dspace-jspui/bitstream/2134/21555/5/Article%20-%20What%20does%20green%20mean%20v6%20Submitted%20%20reformatted%20for%20IR.pdf]{.underline}](https://dspace.lboro.ac.uk/dspace-jspui/bitstream/2134/21555/5/Article%20-%20What%20does%20green%20mean%20v6%20Submitted%20%20reformatted%20for%20IR.pdf)\>

Harnad S., *Self-Archive Unto Others as Ye Would Have them Self-Archive
Unto You,*
\<[[https://jcom.sissa.it/sites/default/files/documents/jcom0203%282003%29F03.pdf]{.underline}](https://jcom.sissa.it/sites/default/files/documents/jcom0203%282003%29F03.pdf)\>

Jenkins C. *et* *al*., *RoMEO Studies 8: Self-archiving -- when Yellow
and Blue make Green: the logic behind the colour-coding in the Copyright
Knowledge Bank*,
\<[[https://www.researchgate.net/publication/28693015\_RoMEO\_Studies\_8\_Self-archiving\_The\_logic\_behind\_the\_colour-coding\_used\_in\_the\_Copyright\_Knowledge\_Bank]{.underline}](https://www.researchgate.net/publication/28693015_RoMEO_Studies_8_Self-archiving_The_logic_behind_the_colour-coding_used_in_the_Copyright_Knowledge_Bank)\>

Mallikarjun D. - Bulu M., *Driving on the Green Road: Self -- Archiving
Research for Open Access in India*,
\<[[https://www.questia.com/library/journal/1G1-331807690/driving-on-the-green-road-self-archiving-research]{.underline}](https://www.questia.com/library/journal/1G1-331807690/driving-on-the-green-road-self-archiving-research)\>

\**Self-Archiving* (*s.v*.), in *Wikipedia*
\<[[https://en.wikipedia.org/wiki/Self-archiving]{.underline}](https://en.wikipedia.org/wiki/Self-archiving)\>

Swan A. - Brown S., *Open access self-archiving: an author study*,
\<[[https://eprints.soton.ac.uk/260999/1/jisc2.pdf]{.underline}](https://eprints.soton.ac.uk/260999/1/jisc2.pdf)\>

\[*Alessandra Di Meglio*\]

# SGML

(ingl. Acronimo per *Standard Generalized Markup Language*)

È il progenitore dei 'markup languages' utilizzati attualmente. Charles
Goldfarb inventò GML (*Generalized Markup Language*) nel 1969 durante il
...
*SGML* venne utilizzato in molti progetti, il primo fu quello sviluppato
dall'*American Association of Publishers* (AAP): selezionarono tre tipi
di testo dal vasto campo dell'editoria, un libro, una serie di
pubblicazioni e un articolo, e ne definirono le rispettive *Document
Type Description* (DTD).

All'interno del documento troviamo tre elementi fondamentali:

1.  La dichiarazione *SGML*, che va sempre posta come apertura di un
    nuovo documento, poiché ne definisce letteralmente il tipo.
    Dichiara, senza troppi giri di parole, che quel documento sarà
    codificato secondo le norme del *SGML*.

2.  La DTD, necessaria in ogni documento. Essa è un insieme di stringhe
...
3.  L'istanza del documento, nella quale viene marcata ogni parte del
...
questa caratteristica dell'*SGML* che venne come uno dei principi
fondamentali del linguaggio in *Gentle Introduction of SGML* di C. M.
...
DeRose S.J. - Durand D. - Milonas E. - Renear A.H., *What is Text,
Really?*, in *Journal of compunting in Higher Education*, 1, 2, 1990,
pp. 3-26

## Sitografia {-}

Goldfarb C.F., *Design Considerations For Integrated Text Processing
System*, in *IBM Cambridge*

*Scientific Center -- Technical Report* *No. 320-2094*, 1973,
\<[[http://www.sgmlsource.com/history/G320-2094/G320-2094.html]{.underline}](http://www.sgmlsource.com/history/G320-2094/G320-2094.html)\>

*SGML Web Page*, \<[<http://www.sil.org/sgml/sgml.html>\>]{.underline}
...
una pagina web, ha dato vita alla *tassonomia* informatica o
...
-   *tassonomia orizzontale*, che si configura come semplice elenco di
    ...
    tag. Il tag coincide con una key*-*words orizzontale e trasversale a
    un *corpus* di contenuti che unisce diversi documenti, anche non
    pertinenti alla specifica ricerca dell'utente, ma affini
    tematicamente;

-   *tassonomia verticale*, in cui i contenuti sono pertinenti a un
...
I vantaggi ottenuti dall'introduzione della *tassonomia* consistono
...
*tassonomia*, infatti, mette gli utenti nella condizione di reperire
...
Isone L., *Strategie SEO per l'E-COMMERCE*, Milano, Hoepli, 2017,
\<[[https://books.google.it/books?id=XjskDwAAQBAJ&pg=PT99&lpg=PT99&dq=tassonomia+orizzontale+e+verticale&source=bl&ots=9GuQqPRwYg&sig=ACfU3U0S6WNix0VGaq70l1yl21x0jk0RVQ&hl=it&sa=X&ved=2ahUKEwjm3v24r5LgAhWGM-wKHUtdDJkQ6AEwCHoECAQQAQ\#v=onepage&q=tassonomia%20orizzontale%20e%20verticale&f=false](https://books.google.it/books?id=XjskDwAAQBAJ&pg=PT99&lpg=PT99&dq=tassonomia+orizzontale+e+verticale&source=bl&ots=9GuQqPRwYg&sig=ACfU3U0S6WNix0VGaq70l1yl21x0jk0RVQ&hl=it&sa=X&ved=2ahUKEwjm3v24r5LgAhWGM-wKHUtdDJkQ6AEwCHoECAQQAQ#v=onepage&q=tassonomia orizzontale e verticale&f=false)\>]{.underline}

## Sitografia {-}

AaVv, *Dall'informatica umanistica alle culture digitali. In memoria di
Giuseppe Gigliozzi*,
\<[<file:///C:/Users/Utente/Downloads/DallInformatica_umanistica_alle_culture.pdf>\>]{.underline}

Minini A., *Le tassonomie verticali e orizzontali*,
\<[<http://www.andreaminini.com/seo/la-tassonomia-del-sito-web-nella-seo>\>]{.underline}

Ruecker S., *A brief taxonomy of prototypes for the Digital Humanities*,
\<[[file:///C:/Users/Utente/Downloads/222-Article%20Text-2065-2-10-20151015.pdf](file:///C:\Users\Utente\Downloads\222-Article%20Text-2065-2-10-20151015.pdf)\>]{.underline}

\**Tassonomia* (*s.v*.), in *Treccani* *Enciclopedia*,
\<[[http://www.treccani.it/enciclopedia/tassonomia/]{.underline}](http://www.treccani.it/enciclopedia/tassonomia/)\>

\**Tassonomia* (*s.v*.), in *Wikipedia*,
\<[<https://it.wikipedia.org/wiki/Tassonomia>\>]{.underline}

Wahl Z. - Busch J., *Il valore della tassonomia nella ricerca delle
informazioni*,
\<[<http://www.datamanager.it/rivista/searching/il-valore-della-tassonomia-nella-ricerca-delle-informazioni/999/>\>]{.underline}

\[*Alessandra Di Meglio*\]

# TEI

(ingl. Acronimo per *Text Encoding Initiative*)
...
Le *TEI Guidelines*, le linee guida su cui si basa il vocabolario della
...
linguaggio, denominata *TEI Lite*, che gli ideatori usarono per fornire
una dimostrazione di come lo schema di codifica *TEI* poteva essere
...
una conoscenza approfondita della *TEI DTD*.

Dal punto di vista pratico, la codifica si divide in due parti:

1.  un *\<tei header\>* in cui sono contenute tutte le informazioni
    relative alle notazioni bibliografiche e di catalogazione del testo
    e le specifiche della codifica;

2.  la trascrizione del testo vero e proprio contenuto nel marcatore
    *\<text\>.*

All'interno del *\<text\>* che possiamo identificare come il macro
...
1.  *\<front\>* che contiene tutto il materiale paratestuale, come
    intestazioni, frontespizio, prefazioni, dediche, ecc., che si trova
    prima del testo vero e proprio;

2.  *\<group\>* mette insieme tutti i testi appartenenti ad un
...
3.  *\<body\>* è riferito ad un testo unitario ad esclusione di tutte le
    aggiunte paratestuali;

4.  *\<back\>* raggruppa invece tutti quei materiali che sono successivi
    al testo. Parliamo, in questo caso, di note, appendici,
    bibliografie, ecc.

Tra questi sotto contenitori del *\<text\>* ciò che ci interessa
maggiormente è quello del *\<body\>* nel quale si concentra il grosso
degli sforzi del codificatore, poiché il suo obbiettivo primario è
quello di rendere fruibile il testo per l'utente.

L'utilizzo delle \<*div*\> per organizzare le porzioni di testo è molto
comune in tutti i progetti che utilizzano la codifica *TEI*, in quanto è
...
-   type: sta ad indicare letteralmente il tipo di categoria a cui
    appartiene la \<*div*\>, che sia riferita ad un capitolo, ad un
...
Essendo *TEI* basato su XML è molto importante ricordarsi di chiudere
...
*TEI Lite* si sono anche dedicati alla creazione di elementi per mettere
in evidenza porzioni di testo:

-   **\<***emph***\>** usato per espressioni che vengono messe in
    qualche modo in risalto.

-   **\<***foreign***\>** atto all'identificazione di parole o frasi in
    una lingua diversa da quella dell'intero testo.

-   **\<***mentioned***\>** indica una menzione o una citazione

-   **\<***title***\>** la quale contiene il titolo di un\'opera, sia
    essa articolo, libro, giornale, o collana, compreso ogni titolo
    alternativo o sottotitolo. Viene spesso completato da degli
    attributi come 'level' che indica se il titolo è di un articolo,
    libro, giornale, collana o materiale inedito, o il già citato
    type**.**

Il *TEI header*, invece, è una sezione iniziale, posizionata esattamente
tra la dichiarazione XML e il tag *\<text\>* e contiene informazioni di
diverso genere:

-   *\<fileDesc\>* contiene una descrizione bibliografica dell'opera
    (titolo, autore, data e luogo di stampa, numero di pagine, ecc.). Al
    suo interno troviamo altri marcatori più specifici quali:

*\<titleStmt\>* in cui troviamo i riferimenti a titolo, autore e
responsabile della codifica.

*\<editionStmt\>* è il gruppo di informazioni riguardanti l'edizione a
testo, nelle quali troviamo anche la descrizione delle particolarità
dell'edizione stessa.

*\<extent\>* descrive quanto pesa il file in *bytes*.

*\<publicationStmt\>* è una sezione obbligatoria, in essa sono contenute
...
*\<seriesStmt\>* è un elemento non obbligatorio circa l'inclusione o
meno del volume in una serie.

*\<noteStmt\>* contengono vari elementi *\<note\>* in cui vengono
specificate le varie annotazioni al testo.

*\<sourceDesc\>* è un elemento obbligatorio che registra tutte le fonti
da cui il file digitale è derivato.

-   *\<encoudingDesc\>* documenta la relazione tra il testo elettronico
    e la fonte o le fonti da cui è derivato.

*\<projectDesc\>* descrive nei dettagli gli scopi e i propositi che si
propone il file codificato, insieme ad altre informazioni sul processo
stesso.

*\<semplingDecl\>* contiene una spiegazione su metodi di codifica.

*\<editorialDecl\>* descrive i principi editoriali e le pratiche
utilizzate durante la codifica.

*\<tagsDecl\>* contiene informazioni circa la marcatura applicata ad un
documento SGML.

*\<refsDecl\>* riassume i riferimenti usati durante la codifica.

*\<classDecl\>* contiene una o più tassonomie che definiscono ciascun
codice di classificazione usato nel testo.

-   *\<profileDesc\>* sottolinea gli aspetti non bibliografici, facendo
...
*\<creation\>* informa su come è stato creato il testo.

*\<laugUsage\>* regista le lingue, le sottolingue, i dialetti, ecc
presentati all'interno del testo.

*\<textClass\>* è una serie di informazioni che descrivono la natura o
l'argomento del testo.

## Sitografia {-}

Burnard L. - Sperberg-McQueen C. M*., TEI Lite: an intorduction to Text
Encodign for Interchange*, 1995 (revisited May 2002),
\<[[https://www.tei-c.org/Vault/P4/Lite/teiu5\_en.pdf]{.underline}](https://www.tei-c.org/Vault/P4/Lite/teiu5_en.pdf)\>

*TEI: Guidelines,* in *Text Encoding Initiative*,
\<[[http://www.tei-c.org/Guidelines/]{.underline}](http://www.tei-c.org/Guidelines/)\>

\[*Alessia Marini*\]

# Thesaurus

Il termine *thesaurus* è -- per così dire -- semanticamente figlio dei
...
carattere enciclopedico e/o divulgativo (*e. g. Thesaurus pauperum*,
ricettario medico *a capite ad pedes* del XIII secolo; il *Trésor* di
Brunetto Latini *et alia*). Successivamente, il termine è utilizzato in
riferimento a vocabolarî, soprattutto delle lingue classiche: *Thesaurus
Linguae Graecae* di Henri Estienne (1572), *Thesaurus Linguae Latinae*
di Robert Estienne (1532), *Thesaurus Linguae Latinae Epigraphicae* di
G. N. Olcott (1904).
...
*thesaurus* oggi viene utilizzato per indicare un database terminologico
...
potrebbe affermare che il *thesaurus*, nella sua accezione moderna, sia
...
definisce il *thesaurus* come «a tool used for the subject indexing of
...
accostare quella elaborata più recentemente dalla *International
Organization for Standardization*, che descrive il *thesaurus* come un
...
L'uso di *thesauri online* va sempre più accrescendosi e ciò è legato ad
...
'strutturato' (cfr. Shiri-Revie 2000, 273-274). In sintesi, i *thesauri*
si configurano come un 'bi-functional tool' e rivelano la propria
utilità sia nell'organizzazione che nel recupero delle informazioni
(cfr. Feldvari 2009). I *thesauri* hanno, inoltre, importanza
trasversale, giacché potenzialmente l'uso di un *thesaurus* può
rivelarsi produttivo in ogni campo del sapere, come è evidente dalla
recente definizione proposta da Ryan (2014, 6): «*thesauri* are vital
...
*Thesauri* allow information professionals to represent content in a
consistent manner and enable researchers, employees and the public to
find this content easily and quickly».

Davies (1996, 38-39) ha proposto una prima classificazione dei *thesauri
online*, suddividendoli -- per quanto attiene al formato e al processo
di pubblicazione -- in 'statici' e 'dinamici'. Shiri-Revie (2000, 274)
...
Per una accurata disamina quantitativa dei principali *thesauri*
liberamente interrogabili in varie lingue europee, cfr. Mochó
Bezares-Sorli Rojo (2010, 643-663).

## Bibliografia consigliata {-}

Aitchinson J. - Gilchrist A. - Bawden D., *Thesaurus construction and
use: a practical manual*, London, Fitzroy Dearden, 2005

Broughton V., *Essential Thesaurus Construction*, London, Facet
Publishing, 2006

Broughton, V., *The need for a faceted classification as the basis of
all methods of information retrieval*, in *Aslib Proceedings: New
Information Perspectives*, 58, 1/2, 2006, pp. 49-72,
\<[[https://www.researchgate.net/publication/32895215\_The\_need\_for\_a\_FC\_as\_the\_basis\_of\_all\_methods\_of\_Information\_retrieval]{.underline}](https://www.researchgate.net/publication/32895215_The_need_for_a_FC_as_the_basis_of_all_methods_of_Information_retrieval)\>

Davies R., *Publishing thesauri on the World Wide Web*, in *Proceedings
of the 7th ASIS SIG/CR Classification Research Workshop* (1996), pp.
37-48,
\<[[http://journals.lib.washington.edu/index.php/acro/article/view/12688/11192]{.underline}](http://journals.lib.washington.edu/index.php/acro/article/view/12688/11192)\>

Feldvari K., *Thesauri usage in Information Retrieval Systems: Example
of LISTA and ERIC Database Thesaurus*, in *INFuture 2009-Digital
Resources and Knowledge Sharing*, 2009, pp. 279-288
\<[[https://infoz.ffzg.hr/infuture/2009/papers/4-09%20Feldvari,%20Thesauri%20usage%20in%20information%20retrieval%20systems.pdf]{.underline}](https://infoz.ffzg.hr/infuture/2009/papers/4-09%20Feldvari,%20Thesauri%20usage%20in%20information%20retrieval%20systems.pdf)\>
...
Mochón Bezares G. - Sorli Rojo A., *Thesauros en acceso abierto en
Internet. Un análisis cuantitativo*, in *Revista Española de
Documentación Cientifica*, 33, 4, 2010, pp. 643-663,
\<[[http://redc.revistas.csic.es/index.php/redc/article/view/675/750]{.underline}](http://redc.revistas.csic.es/index.php/redc/article/view/675/750)\>

Ryan C., *Thesauri Construction Guidelines: An Introduction to thesauri
and guidelines on their construction*, Dublin 2014,
\<[[http://apps.dri.ie/motif/docs/guidelines.pdf]{.underline}](http://apps.dri.ie/motif/docs/guidelines.pdf)\>

Shiri A. A. - Revie C., Thesauri *on the web: current developments and
trends*, in *Online Information Review* 24, 4, 2000, pp. 273-279,
\<[[https://strathprints.strath.ac.uk/1896/1/strathprints001896.pdf]{.underline}](https://strathprints.strath.ac.uk/1896/1/strathprints001896.pdf)\>

## Sitografia {-}

\**Quick Guide to publishing a Thesaurus on the Semantic Web*,
\<[[https://www.w3.org/TR/2005/WD-swbp-thesaurus-pubguide-20050517/]{.underline}](https://www.w3.org/TR/2005/WD-swbp-thesaurus-pubguide-20050517/)\>

\* *Thesaurus* (*s. v.*)*,* in *Treccani*,
\<[[http://www.treccani.it/enciclopedia/thesaurus/]{.underline}](http://www.treccani.it/enciclopedia/thesaurus/)\>

\* *Thesaurus* *interrogabili* (*s. v.*)*,* in *Treccani*,
\<[[http://www.treccani.it/vocabolario/thesaurus/]{.underline}](http://www.treccani.it/vocabolario/thesaurus/)\>

\**Thesaurus Linguae Grecae* (online),
\<[[http://stephanus.tlg.uci.edu/]{.underline}](http://stephanus.tlg.uci.edu/)\>

\**Thesaurus Linguae Latinae* (online),
\<[[https://www.degruyter.com/view/db/tll]{.underline}](https://www.degruyter.com/view/db/tll)\>

\**Thesaurus Linguae Latinae Epigraphicae* (online, scaricabile), I,
\<[[https://archive.org/details/ThesaurusLinguaeLatinaeEpigraphicae]{.underline}](https://archive.org/details/ThesaurusLinguaeLatinaeEpigraphicae)\>

\**Thesaurus Musicarum Latinarum* (online),
\<[[http://boethius.music.indiana.edu/tml/]{.underline}](http://boethius.music.indiana.edu/tml/)\>

\[*Giovanna Battaglino*\]

# Web Semantico

Il *Web Semantico*, detto anche 'Web dei dati' è l\'insieme dei servizi
...
Da un punto di vista strutturale il *Web Semantico* è stato
...
all\'architettura del *Web Semantico* sono rappresentati da metadati;
...
Per definire una fondamentale caratteristica del *Web Semantico* si fa
riferimento agli open data e in particolare alla disponibilità dei dati
e alla conseguente possibilità di identificarli e citarli. Il *Web
...
La prospettiva di un *Web Semantico* realmente sviluppato non è ancora
...
bibliotecari (OPAC, *On-line public access catalogue*).
...
Berners-Lee T., *L\'architettura del nuovo Web. Dall\'inventore della
...
*\*Web semantico* (*s.v*.), in *Treccani* - *Lessico del XXI secolo*,
\<[[http://www.treccani.it/enciclopedia/web-semantico\_%28Lessico-del-XXI-Secolo%29/]{.underline}](http://www.treccani.it/enciclopedia/web-semantico_%28Lessico-del-XXI-Secolo%29/)\>
...
definito come foglio di stile, l'*XSL* è più che altro un insieme di
...
linguaggi, quello maggiormente interessante è l'*XSLT* (*Extensible
...
Un documento *XSLT* si compone di tre fasi fondamentali: nella prima
*\<xsl: output\>* è il marcatore che specifica il tipo di formato in cui
verrà visualizzato il documento finale, ad es. HTML, mentre
*\<xsl:template\>* specifica quali parti del documento XML dovranno
...
parole più semplici il compito dell'*XSLT* è quello di prendere le
...
Moller A. - Schwartzbach M.I. - Gaburri S. (a cura di), *Introduzione a
XML*, Milano, Pearson, 2007
...
\**Learn W3C* (*s.v*.), in *w3schools.com*,
\<[<http://www.w3schools.com/>\>]{.underline}
...
Assieme ad HTML (*HiperText Markup Language*), è un linguaggio di
marcatura derivato da SGML (*Standard Generalized Markup Language*).
...
Il progetto per lo sviluppo del *XML* ha inizio nel 1996 con il fine di
ampliare e potenziare la capacità di gestione ed elaborazione dei
documenti sul Web; per questo venne creato un gruppo di lavoro *XML
...
(*Web Consortium*), il linguaggio divenne uno standard internazionale.

*XML* può essere pensato come un sottoinsieme di SGML da cui eredita sia
la sintassi sia la logica di funzionamento. Al contrario dell'HTML,
*XML* non ha dei marcatori fissi e determinati, ma, come ci suggerisce
il nome, è estensibile e modificabile. Tutto ciò è possibile grazie
all'uso di una DTD (*Document Type Description*): è importante avere ben
chiaro, prima di iniziare ad avventurarsi nella pratica di questo
linguaggio, che non può esistere un file *XML* privo di DTD in quanto
essa ne rappresenta implicitamente le fondamenta.

Un'altra differenza fondamentale con l'HTML è che esso si preoccupa più
di descrivere i particolari fisici del documento (utilizzando *\<i\>
\</i\>* per segnalare un titolo in corsivo), l'*XML* invece preferisce
un tipo di descrizione degli aspetti logici, così un titolo in corsivo
viene marcato come *\<title\>* per differenziarlo logicamente, e non
...
Altra peculiarità dell'*XML* è il foglio di stile necessario per la
visualizzazione sui browser: chiamato XSL (*Exstensible Stylesheet
...
Indispensabile in ogni documento *XML* è il prologo nel quale è
...
Sorato A., *Linguaggi per la rete: XML*,
\<[<http://www.dsi.unive.it/~asorato/SlideXML/DTD.pdf>\>]{.underline}
